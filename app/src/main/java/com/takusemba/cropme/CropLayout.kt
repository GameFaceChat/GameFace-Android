...
import com.takusemba.cropme.internal.TouchListener
import com.takusemba.cropme.overlays.CircleCropOverlay
import com.takusemba.cropme.overlays.CropOverlay
import com.takusemba.cropme.overlays.NoneCropOverlay
import com.takusemba.cropme.overlays.RectangleCropOverlay
...
class CropLayout @JvmOverloads constructor(
    ...
    defStyleAttr: Int = 0
) : FrameLayout(context, attrs, defStyleAttr), TouchListener {
  ...
  init {
    ...
    vto.addOnPreDrawListener(object : ViewTreeObserver.OnPreDrawListener {
      ...
      override fun onPreDraw(): Boolean {
        ...
        val animation = GestureAnimation(cropOverlay, this@CropLayout, animator)
        animation.start()
        when {
  ...
  fun rotateImage(angle: Float) {
    ...
    val rotatedBitmap = Bitmap.createBitmap(bitmapOrg, 0, 0, bitmapOrg.width, bitmapOrg.height, matrix, true)
  ...
  override fun onTouch(event: MotionEvent?) {
    cropOverlay.onTouchEvent(event)
  }
}
